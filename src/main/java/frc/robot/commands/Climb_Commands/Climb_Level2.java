...
public class Climb_Level2 extends Command {
  private Climb_Subsystem Climb_Subsystem;

  /** Creates a new Climb_First_Level_Command. */
  public Climb_Level2(Climb_Subsystem Climb_Subsystem) {
  ...
  public boolean isFinished() {
    return Climb_Subsystem.atSetPoint() || 
           Math.abs(Climb_Subsystem.get_inches() - ClimbConstants.Second_Rung_Distance) < 0.75;
  }
}
