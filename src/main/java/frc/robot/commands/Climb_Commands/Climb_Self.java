...
public class Climb_Self extends Command {
  private Climb_Subsystem Climb_Subsystem;

  /** Creates a new Climb_First_Level_Command. */
  public Climb_Self(Climb_Subsystem Climb_Subsystem) {
  ...
  public boolean isFinished() {
    return Climb_Subsystem.atSetPoint() || 
           Math.abs(Climb_Subsystem.get_inches() - ClimbConstants.Robot_Back_Distance) < 0.75;
  }
}
