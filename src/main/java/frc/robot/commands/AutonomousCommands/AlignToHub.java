...
public class AlignToHub extends SequentialCommandGroup {
  public AlignToHub(DriveSubsystem tankDrive, ShooterSubsystem shooter, LimelightSubsystem limelight, PigeonSubsystem pigeon) {
    addCommands(
      new AlignToTarget(tankDrive, limelight, pigeon),
